...
jmaki.subscribe("/fornitore/onSelect", function(args) {
        jmaki.log("glue.js : fornitore select request from: " + args.widgetId);
            widges=jmaki.getWidget(args.widgetId);
            jmaki.doAjax(
                { method : "POST", url : jmaki.webRoot + "/faces/fornitoreController-seleziona_Fornitore.ajax",
                    content : { cmd : 'setValue', value : args.value.toSource()},
                    callback: function(req) {
                        jmaki.log("Back from service : " + req.responseText);
                    },
...
jmaki.subscribe("/rappresentante/onSelect", function(args) {
        jmaki.log("glue.js : rappresentante select request from: " + args.widgetId);
            widges=jmaki.getWidget(args.widgetId);
            jmaki.doAjax(
                { method : "POST", url : jmaki.webRoot + "/faces/rappresentanteController-seleziona_Rappresentante.ajax",
                    content : { cmd : 'setValue', value : args.value.toSource()},
                    callback: function(req) {
                        jmaki.log("Back from service : " + req.responseText);
                    },
